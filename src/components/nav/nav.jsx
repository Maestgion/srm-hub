      ...
      <div className="container flex flex-wrap items-center justify-between mx-auto border-gray-200 border w-[90%] sm:px-4 py-2.5 rounded-2xl shadow-sm">
        ...
        <div className="flex gap-4 justify-center items-center">
          {signup && (
            <Link
              to="/signup"
              class="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-4 focus:ring-gray-200">
              Sign Up
            </Link>
          )}
          <Link
